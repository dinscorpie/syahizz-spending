...
DROP POLICY "Family members can view family receipts" ON public.receipts;
DROP POLICY "Family members can insert receipts" ON public.receipts;
DROP POLICY "Receipt creators and family admins can update receipts" ON public.receipts;
DROP POLICY "Receipt creators and family admins can delete receipts" ON public.receipts;
...
-- Update existing receipts to have added_by and family_id
UPDATE public.receipts 
SET added_by = (user_id)::uuid,
    family_id = (
      SELECT fm.family_id 
